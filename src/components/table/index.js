        ...
        <Card className='my-5'>
            <CardBody>
                ...
                <div className="flex flex-col gap-4 py-2">
                    {transactions.slice(0, expanded ? transactions.length : 2).map((transaction, index) => (
                        <div key={index} className="flex gap-4 border-b py-2 transition-all duration-300 ">
                            ...
                            <div className="flex flex-col w-3/5">
                                ...
                                <span className="text-gray-500 text-tiny font-bold">recibido {transaction.date}</span>
                            </div>
