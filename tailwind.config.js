...
module.exports = {
  ...
  theme: {
    ...
    textStroke: {
      sm: '1px',  // Contorno fino
      md: '2px',  // Contorno mediano
      lg: '3px'   // Contorno grueso
    },
    colors: {
      ...
      '3xl': '0px 0px 30px 1px rgba(0, 255, 117, 0.3)',
      ...
      yellow: {
        ...
        800: '#92400e',
        900: '#78350f',
        funded: 'rgb(224, 190, 119,1)',
        'funded-50': 'rgb(219, 182, 107,1)',
        'funded-70': 'rgb(255, 227, 171,1)',
        'funded-80': 'rgb(255, 227, 171,1)',
        'funded-90': 'rgb(226, 200, 137,1)',
      },
      green: {
        50: '#ecfdf5',
        100: '#d1fae5',
    ...
    backgroundImage: {
      ...
      none: 'none',
      blue2: 'linear-gradient(180deg,#f5377c,#ffd78d)',
      'gradient-hero': 'linear-gradient(163deg, #00ff75 0%, #3700ff 100%)',
      'gradient-white':
  ...
  plugins: [
    ...
    function ({ addUtilities }) {
      const newUtilities = {
        '.text-stroke-sm': {
          '-webkit-text-stroke': '1px #f8f2e5',
        },
        '.text-stroke-md': {
          '-webkit-text-stroke': '2px #f8f2e5',
        },
        '.text-stroke-lg': {
          '-webkit-text-stroke': '3px #f8f2e5',
        },
      }
